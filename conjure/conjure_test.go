...
type myNotFound struct {
	// This is type doc.
	Type string ` + "`" + `json:"type" conjure-docs:"This will fail to render."` + "`" + `
}
...
// NewMyNotFound returns new instance of MyNotFound error.
func NewMyNotFound(type string) *MyNotFound {
	return &MyNotFound{errorInstanceID: uuid.NewUUID(), myNotFound: myNotFound{Type: type}}
}
